...
import get_batch_wishes.get_batch_wishes as get_batch_wishes
...
@app.route("/get_batch_wishes", methods=['POST', 'GET'])
@app.route("/getBatchWishes", methods=['POST','GET'])
def route_get_wishes_extended():
    return process_json_api_call(get_batch_wishes)
